...
PROFILE_A_CONFIG = RuntimeConfig(
    ...
    cardano_cli=Path("${HOME}/.local/bin/cardano-cli"),
    cardano_node=Path("${HOME}/.local/bin/cardano-node"),
    network_magic="42",
    blockfetch_bin="${HOME}/dwarf-fw/targets/amaru/target/release/dwarf-amaru-runtime-blockfetch",
    chainsync_bin="${HOME}/amaru-verification/target/debug/amaru",
    log_paths=(
