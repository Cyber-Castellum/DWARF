...
def run_protocol_fault(
    *,
    ...
    peersharing_decoder_path: str = "/home/USER/dwarf-fw/targets/cardano-node/bin/cardano-node-mini-protocol-decode-peersharing",
    peersharing_state_corpus: str = "/home/USER/dwarf-fw/corpora/m3/peersharing-sequences.json",
    localtxmonitor_decoder_path: str = "/home/USER/dwarf-fw/targets/cardano-node/bin/cardano-node-mini-protocol-decode-localtxmonitor",
    localtxmonitor_state_corpus: str = "/home/USER/dwarf-fw/corpora/m3/localtxmonitor-state-machine.json",
) -> dict:
...
def main(argv: list[str] | None = None) -> int:
    ...
    report = run_protocol_fault(
        ...
        peersharing_decoder_path=str(config.get("peersharing_decoder_path", "/home/USER/dwarf-fw/targets/cardano-node/bin/cardano-node-mini-protocol-decode-peersharing")),
        peersharing_state_corpus=str(config.get("peersharing_state_corpus", "/home/USER/dwarf-fw/corpora/m3/peersharing-sequences.json")),
        localtxmonitor_decoder_path=str(config.get("localtxmonitor_decoder_path", "/home/USER/dwarf-fw/targets/cardano-node/bin/cardano-node-mini-protocol-decode-localtxmonitor")),
        localtxmonitor_state_corpus=str(config.get("localtxmonitor_state_corpus", "/home/USER/dwarf-fw/corpora/m3/localtxmonitor-state-machine.json")),
    )
    print(
        " ".join(
            [
