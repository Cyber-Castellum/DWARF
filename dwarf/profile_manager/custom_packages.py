...
REMOTE_AMARU_SOURCE_PATH = "/home/USER/amaru-verification"
REMOTE_AMARU_DOCKERFILE_PATH = "/home/USER/amaru-verification/docker/Dockerfile.amaru"
...
def package_deploy_dry_run_text(package, profile):
    ...
    lines.extend(
        [
            ...
            f"Would create Haskell runtime env under {profile['runtime_root']}/env via /home/USER/.local/bin/cardano-testnet create-env.",
            "Would run Haskell nodes from /home/USER/.local/bin/cardano-node under tmux sessions scoped to this profile.",
            "Would run Amaru nodes from /home/USER/amaru-verification/target/debug/amaru under tmux sessions scoped to this profile.",
...
def package_deploy_command(package, profile):
    ...
    cardano_node_bin = shlex.quote("/home/USER/.local/bin/cardano-node")
    cardano_cli_bin = shlex.quote("/home/USER/.local/bin/cardano-cli")
    cardano_testnet_bin = shlex.quote("/home/USER/.local/bin/cardano-testnet")
...
def create_interactive_bundle(output_path):
    ...
    profile = {
        ...
        "runtime_root": f"/home/USER/cardano-profiles/{package_id}",
    }
